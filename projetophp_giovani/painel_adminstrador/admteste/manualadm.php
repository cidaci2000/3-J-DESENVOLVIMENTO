...
<body>
    ...
    <div class="container">
        ...
        <p>Este manual fornece instruções sobre como <strong>adicionar clientes</strong> e <strong>produtos</strong> ao sistema.</p>

        <h2>Adicionar Clientes</h2>
        <p>Para adicionar um novo cliente, siga os passos abaixo:</p>
        <ul>
            <li>1. Navegue até a seção de <strong>"Cadastro de Clientes"</strong>.</li>
            <li>2. Preencha os seguintes campos:
                <ul>
            ...
            <li>3. Clique no botão <strong>"Adicionar Cliente"</strong>.</li>
            <li>4. Verifique se o cliente foi adicionado na lista de clientes.</li>
        </ul>

        <h2>Adicionar Produtos</h2>
        <p>Para adicionar um novo produto, siga os passos abaixo:</p>
        <ul>
            <li>1. Navegue até a seção de <strong>"Cadastro de Produtos"</strong>.</li>
            <li>2. Preencha os seguintes campos:
                <ul>
            ...
            <li>3. Clique no botão <strong>"Adicionar Produto"</strong>.</li>
            <li>4. Verifique se o produto foi adicionado na lista de produtos.</li>
        </ul>
    </div>
    <footer>
        <p><strong> 13/10/2024 Sampaio Cosméticos</strong></p>
    </footer>
</body>
</html>
