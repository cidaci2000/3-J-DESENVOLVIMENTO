...
<body>
    ...
    <div class="container">
        ...
        <form onsubmit="return produto();">
            <input type="text" placeholder="Nome do produto" maxlength="100" required>
            <input type="text" placeholder="Marca" maxlength="100" required>
            <input type="number" placeholder="Preço" required>
            <input type="text" placeholder="Descrição do produto" maxlength="1000">
    ...
    <div class="container">
        ...
        <form id="couponForm" onsubmit="return cadastrarCupom();">
            <input type="text" placeholder="Nome do cupom" maxlength="100" required>
            <input type="number" placeholder="Desconto do cupom (%)" min="1" max="100" required>
            <input type="number" placeholder="Quantidade" required>
            <button type="submit">Cadastrar cupom</button>
            <div class="message" id="message">Cupom cadastrado com sucesso!</div>
            <div class="error" id="error">Erro ao cadastrar o cupom. Tente novamente.</div>
        </form>
    </div>
