...
<head>
    <meta charset="UTF-8">
    <title>Produto - Hello Kitty</title>
...
<body>
    ...
    <div class="produto-container">
        ...
        <div class="produto-detalhes">
            <h1>Hello Kitty</h1>
            <p><strong>Preço:</strong> R$50,99</p>
            <p><strong>Descrição:</strong> Almofada charmosa da Hello Kitty. Perfeita para decoração, 35cm.</p>
            <p><strong>Material:</strong> Poliéster premium</p>
            <p><strong>Altura:</strong> 40 cm</p>
            <p><strong>Fabricante:</strong> Almofadinhas Ltda.</p>
            <button class="botao-compra" onclick="adicionarAoCarrinho('Hello Kitty', 50.99)">Adicionar ao carrinho</button>
        </div>
    </div>
