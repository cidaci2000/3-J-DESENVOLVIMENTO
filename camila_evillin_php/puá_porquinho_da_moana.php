...
<head>
    <meta charset="UTF-8">
    <title>Produto - Puá Porquinho da Moana</title>
...
<body>
    ...
    <div class="produto-container">
        <div class="produto-img">
            <img src="porquinho.jpeg" alt="Puá Porquinho da Moana">
        </div>
        <div class="produto-detalhes">
            <h1>Puá Porquinho da Moana</h1>
            <p><strong>Preço:</strong> R$40,00</p>
            <p><strong>Descrição:</strong> Puá, o porquinho fofo da Moana agora em almofada! Tecido suave, 40cm.</p>
            <p><strong>Material:</strong> Poliéster premium</p>
            <p><strong>Altura:</strong> 40 cm</p>
            <p><strong>Fabricante:</strong> Almofadinhas Ltda.</p>
            <button class="botao-compra" onclick="adicionarAoCarrinho('Puá Porquinho da Moana', 40.00)">Adicionar ao carrinho</button>
        </div>
    </div>
